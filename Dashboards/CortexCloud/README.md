...
| [CNAPP - SecOps Issues Analysis Dashboard](posture_issues/) | CNAPP posture issues with detailed breakdowns by severity, status, category, and asset context **with Asset Group filter**                                                         |  No | Oleg Kostine | :uk: |
