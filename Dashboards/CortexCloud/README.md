...
| [CORTEX AppSec Findings Dashboard](cortex_appsec_findings/) | Cortex AppSec Findings view table with filters and download option                                                          |  No | Oleg Kostine | :uk: |
...
| [CNAPP - SecOps Issues Analysis Dashboard](posture_issues/) | CNAPP posture issues with detailed breakdowns by severity, status, category, and asset context **without Asset Group filter**                                                         |  No | Oleg Kostine | :uk: |
| [CNAPP - SecOps Issues Analysis Dashboard](posture_issues_with_assetgroups/) | CNAPP posture issues with detailed breakdowns by severity, status, category, and asset context **with Asset Group filter**                                                         |  No | Oleg Kostine | :uk: |
| [CNAPP - Cloud Health Ingestion/Scan Status Dashboard](cloud_health_status/) | Cloud Health ingestion/scans auditing errors across providers, assets, regions, and error messages                                                                                                  |  No | Oleg Kostine | :uk: |
